 ...
 * @description Subscriptions list page — displays all subscriptions for the user.
 *
 * Server Component. Fetches all subscriptions associated with the user
 * and displays them in two tables:
